...
const component = () => {
  return (
    <section className="pt-10 overflow-hidden bg-[#fbf8e9] md:pt-0 sm:pt-16 2xl:pt-16">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid items-center grid-cols-1 md:grid-cols-2">
          <div>
            <h1 className="text-3xl font-bold leading-tight text-[#154a2c] sm:text-4xl lg:text-5xl">
              Cut back on your drinking with no pressure to quit
            </h1>
            <p className="max-w-lg mt-3 text-lg leading-relaxed text-[#345753] md:mt-8">
