    ...
    <Section id="hero" className="pt-10 overflow-hidden bg-white md:pt-0 sm:pt-16 2xl:pt-16">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid items-center grid-cols-1 md:grid-cols-2">
          <div>
            <h1 className="text-center text-3xl font-bold leading-tight text-primary-dark md:text-left sm:text-4xl lg:text-5xl">
              Cut back on your drinking with no pressure to quit
            </h1>
            <p className="text-center max-w-lg mt-3 text-lg leading-relaxed text-primary md:text-left md:mt-8">
            ...
            <div className="mt-8 flex justify-center md:justify-start">
              <Link type="secondary" size="lg" to="#" >How it works</Link>
            </div>
          </div>
